  ...
  try {
    ...
    switch (fromFormat) {
      ...
      case "DD-MM-YYYY":
        ...
        date = new Date(Number.parseInt(yyyy, 10), Number.parseInt(mm, 10) - 1, Number.parseInt(dd, 10))
        break
      ...
      case "DD/MM/YYYY":
        ...
        date = new Date(Number.parseInt(y2, 10), Number.parseInt(m2, 10) - 1, Number.parseInt(d2, 10))
        break
