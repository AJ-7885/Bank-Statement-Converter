      ...
      <CardContent>
        <div className="max-h-96 overflow-auto border rounded-lg">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="sticky top-0 bg-white border-b">
                  Date
                </TableHead>
                <TableHead className="sticky top-0 bg-white border-b">
                  Category
                ...
                <TableHead className="sticky top-0 bg-white border-b text-right">
                  D- Unit
                </TableHead>
                <TableHead className="sticky top-0 bg-white border-b text-right">
                  C- Unit
        ...
        {data.length > 100 && (
          <p className="text-sm text-gray-500 mt-3 text-center">
            Showing first 100 rows. Download CSV to see all {data.length}{" "}
            transactions.
          </p>
        )}
      </CardContent>
